...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Arduino + Sensor -->
        <a href="{{ route('arduino.sensor') }}" class="block">
            <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6 border-t-4 border-teal-500">
                <div class="flex items-center mb-4">
        ...
        <!-- NUEVA: Desarrolladores -->
        <a href="{{ route('desarrolladores') }}" class="block">
            <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6 border-t-4 border-indigo-500">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="ml-4 text-xl font-semibold text-gray-800">Desarrolladores</h3>
                </div>
                <p class="text-gray-600 mb-4">Conoce al equipo detrás del proyecto</p>
                <span class="text-indigo-600 text-sm font-medium">Ver equipo →</span>
            </div>
        </a>

        <!-- NUEVA: Acerca de -->
        <a href="{{ route('acerca-de') }}" class="block">
            <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6 border-t-4 border-pink-500">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="ml-4 text-xl font-semibold text-gray-800">Acerca de</h3>
                </div>
                <p class="text-gray-600 mb-4">Información del proyecto e ITCA-FEPADE</p>
                <span class="text-pink-600 text-sm font-medium">Ver información →</span>
            </div>
        </a>
    </div>
    ...
    <div id="nuevoModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="space-y-3">
                    <a href="{{ route('mru') }}" class="block w-full bg-cyan-600 hover:bg-cyan-700 text-white font-medium py-3 px-4 rounded text-center">
                        MRU
                    </a>
                    ...
                    <a href="{{ route('mediciones.create') }}" class="block w-full bg-orange-600 hover:bg-orange-700 text-white font-medium py-3 px-4 rounded text-center">
                        Mediciones
                    </a>
                    <a href="{{ route('arduino.sensor') }}" class="block w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 px-4 rounded text-center">
                        Arduino + Sensor
                    </a>
